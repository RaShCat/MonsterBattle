...
public class ThisIsCode {
	...
	public static void main(String[] args) {
            ...
            System.out.print("Введите характеристики 1-го персонажа :");
            System.out.print("ATTACK :");
            ...
            if(health2 > 0){
    			...
    			if(health1 > 0) {
        			...
        			if(health1 > 0) {
        				...
        				System.out.print(health1);
        				System.out.println(" очков");
        				// 1-ой персонаж даёт сдачи 2-ый персонаж
            			System.out.println("2-ой персонаж атакует 1-ый персонаж");
            			if(attack1 > defense2) {
            				percent = (attack1 - defense2) * 0.05;
            				if(percent > 4) {
            			...
            			if(health2 > 0) {
            				...
            				System.out.println("2-ый персонаж убит");
            			}        				
        			} else {
